...
def naiveSoftmaxLossAndGradient(
    ...
    softmax_vector = softmax(np.dot(outsideVectors, centerWordVec)) #shape = (N, )
    loss = -np.log(softmax_vector[outsideWordIdx])  #number
...
def negSamplingLossAndGradient(
    ...
    #to avoid repeating of values in negative indexies we should add values instead of assigning
