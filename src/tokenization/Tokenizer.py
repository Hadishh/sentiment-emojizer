...
class Tokenizer:
    ...
    def train(self, test_pieces):
        ...
        spm.SentencePieceTrainer.Train(f"input={TOKENIZATION_TRAIN_FILE} --vocab_size={self.vocab_size} --model_prefix={BASE_TOKENIZATION_URL} --model_type={self.model_type}")
